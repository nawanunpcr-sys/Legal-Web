...
2) ระบุ "วันที่ประกาศ" (วันที่ลงราชกิจจานุเบกษา) และ "กฎการบังคับใช้"
   ...
   ใส่ excerpt = ข้อความจากตัวบทที่บอกวันบังคับใช้ คัดคำต่อคำ เพื่อให้ตรวจสอบย้อนหลังได้
...
4) แตกเป็น "ข้อกำหนด" รายมาตรา/ข้อ ให้ครบทุกข้อที่สร้างหน้าที่ต้องปฏิบัติ — อย่ารวบ อย่าตกหล่น แต่ละข้อสรุปครบ: ใคร(ผู้รับผิดชอบ) ทำอะไร ที่ไหน อย่างไร เอกสาร/หลักฐาน ความถี่ และเงื่อนไข/กำหนดเวลา ระบุเลขมาตรา/ข้อเสมอ
   ...
   ทุกข้อต้องมี source_excerpt คัดข้อความจากตัวบทจริงมาแบบคำต่อคำ
   และ "ต้องครอบคลุมตัวเลขทุกตัว" ที่คุณเขียนลงใน req_text (อัตรา วงเงิน วันที่ จำนวนวัน ระดับ)
   ระบบจะตรวจว่าตัวเลขในข้อความมีอยู่ในข้อความที่คัดมาจริงหรือไม่ ไม่มี = ขึ้นเตือนให้ผู้ใช้ตรวจ
...
{"law":{"name":"","type":"","ministry":"","announce_date":"วว/ดด/ปปปป","effective_date":"วว/ดด/ปปปป","effective_rule":{"type":"next_day|same_day|after_days|fixed_date|conditional","days":0,"date":"","excerpt":"ข้อความจากตัวบทที่บอกวันบังคับใช้"},"documents":"","cat":"LA","code_suggestion":"","gazette_ref":"เล่ม 143 ตอนที่ 17 ก หน้า 4-7 หรือค่าว่าง"},
 "repeals":[{"law_name":"ชื่อกฎหมายที่ตัวบทสั่งให้ยกเลิก","clause":"มาตราที่สั่งยกเลิก"}],
 "requirements":[{"section_ref":"มาตรา X","req_text":"","source_excerpt":"ข้อความจากตัวบทจริงคำต่อคำ ต้องมีตัวเลขทุกตัวที่ใช้ใน req_text","responsible":"","applicability":"","method":"","documents":"","frequency":"","other_terms":""}],
