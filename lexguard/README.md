...
6. **Gap Analysis** (P22) — ช่องว่าง 5 กลุ่มเรียงตามความเสี่ยง + ความพร้อมตรวจ ISO 45001 ข้อ 6.1.3
...
| Gap Analysis + ISO 45001 | เมนู "Gap Analysis" · `src/lib/gap.js` เป็นแหล่งคำนวณเดียว |
