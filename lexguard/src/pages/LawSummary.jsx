...
// pending_issuance ห้ามอ่านว่า "ยังไม่มีตัวบท" — ระบบไม่ได้ค้นฉบับนั้นเลยสักครั้ง
// เจอจริง: 3 ใน 7 จุดของกฎกระทรวงควบคุมสถานประกอบกิจการฯ 2560 มีประกาศออกมาแล้ว
const SRC_LABEL = {
  answered:         { t: 'ตามกฎหมายที่อ้างถึง',   c: 'var(--ok)' },
  pending_issuance: { t: 'ต้องตรวจสอบเพิ่มเติม',  c: 'var(--warn)' },
